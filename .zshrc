...
#export PATH=$PATH:~/bin/qutebrowser-1.6.1/qutebrowser
#export EDITOR="emacsclient -nw "

#alias xi='xinput --map-to-output 23 HDMI-0'
#xrandr --output DVI-I-1 --rotate right
#bash ~/.config/i3/scripts/remaps
#alias rb='~/.config/i3/scripts/remaps'
